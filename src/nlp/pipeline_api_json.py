...
from nlp.config_beaderstadt import (
    API_URL,
    DATA_PATH,
...
from nlp.stage02_validate_beaderstadt import run_validate
from nlp.stage03_transform_beaderstadt import run_transform
